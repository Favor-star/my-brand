...
const ReviewSection = () => {
  ...
  return (
    <span className="w-full flex justify-center items-center  px-3">
      <section className="w-full max-w-screen-lg flex flex-col gap-4 justify-center items-center my-8 mt-10 relative ">
        ...
        <p className="text-start self-start text-sm">
            I have worked with tons of people. They have been highly impressed with the way I
            handled theier tasks. While reviewing them, consider how impressed they are. Ask
            yourself, why can't I hire him?
          </p>
          <Arrows
